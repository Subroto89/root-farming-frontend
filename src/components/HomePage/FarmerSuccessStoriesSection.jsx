  ...
  return (
   <div className="max-w-7xl mx-auto py-16 rounded mt-16">
         ...
         <div className="text-center mb-12">
            ...
            {/* Story Card --------------------------------*/}
            <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-xl shadow-xl p-8 lg:p-12 mb-12">
            ...
            <div className="bg-green-600 text-white rounded-2xl shadow-xl p-8 lg:p-12 text-center">
               ...
               <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
                  ...
                  agricultural business with Root Farming's innovative platform
                  and expert support.
               </p>
