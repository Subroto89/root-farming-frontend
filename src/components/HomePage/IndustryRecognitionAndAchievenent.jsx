...
const IndustryRecognitionAndAchievenent = () => {
   const achievements = [
      ...
      },
      {
         ...
         description:
            "Awarded for outstanding contribution to sustainable farming.",
      },
      {
         icon: Star,
         title: "Top 100 Startups",
         description:
            "Listed among the top 100 most impactful startups worldwide.",
      },
      {
         icon: Medal,
         title: "Excellence in Technology",
         description:
            "Honored for cutting-edge agricultural technology solutions.",
      },
   ];
   return (
      <div className="my-16">
