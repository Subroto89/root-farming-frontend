...
const WeatherForecast = () => {
   ...
   const getWeatherIcon = (condition) => {
      switch (condition) {
         ...
         case "rainy":
            return (
               <CloudRain className="h-10 w-10 text-blue-500 drop-shadow-lg" />
            );
         default:
   ...
   return (
      <div className="  py-20 bg-gradient-to-br from-blue-50 via-green-50 to-teal-100 rounded-xl mt-16">
