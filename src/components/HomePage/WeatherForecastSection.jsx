...
const WeatherForecastSection = () => {
  ...
  return (
   <div className="relative min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 py-8 sm:py-20 px-4 sm:px-6 lg:px-10 overflow-x-hidden">
         {/* Background blobs */}
         ...
         <div className="relative z-10 max-w-7xl mx-auto flex flex-col gap-8 sm:gap-12">
            ...
            >
               <input
                  ...
                  className="flex-1 px-4 py-2 sm:px-5 sm:py-3 lg:px-6 lg:py-2 bg-white/50 backdrop-blur-md border border-gray-300 rounded-xl text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-700 transition text-sm sm:text-base "
               />
               <button
                  type="submit"
                  className="bg-green-700 text-white px-6 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-2 rounded-xl font-semibold hover:bg-green-800 transition flex items-center justify-center text-sm sm:text-base"
               >
            ...
            {weather && (
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 ">
                  {/* Temperature Card */}
                  <div className="flex flex-col items-center justify-center text-center p-6 sm:p-8 md:p-10 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-xl hover:scale-105 transform transition duration-300">
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  {farmingTips.map((tip, index) => (
                     ...
                     >
                        ...
                        >
                           {tip.priority.charAt(0).toUpperCase() +
                              tip.priority.slice(1)}{" "}
                           Priority
                        </span>
                     </div>
                  ))}
