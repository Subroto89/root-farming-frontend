      ...
      <div className={`${themeBackgroundStyle} min-h-screen`}>
        ...
        ---------------------------------------------------------------*/}
               <div>
                  {categories.length > 0 ? (
                     <div
                        className={`${themeForegroundStyle} min-h-[calc(100vh-116px)] w-full overflow-auto rounded-lg mt-10 shadow-lg`}
                     >
                        <table
                           className={`${themeForegroundStyle} w-full divider-y divider-gray-500`}
                        >
                           <thead
