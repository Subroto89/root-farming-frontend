                      ...
                      <tbody>
                        {variants.map((variant) => (
                          <VariantRow
                            ...
                            handleUpdateVariantModal={handleUpdateVariantModal}
          ...
          {isModalOpen && (
            <div>
              <ModalFormat
                ...
                form={<FormInAddVariant handleUpdateVariantModal={handleUpdateVariantModal} handleModalToggle={handleModalToggle} refetch={refetch}/>}
              />
            </div>
          )}
        </div>
