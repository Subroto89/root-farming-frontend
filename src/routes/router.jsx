...
const router = createBrowserRouter([
   ...
   // -------------------------------------------
   {
      ...
      children: [
         ...
         {
            // Consolidated multiple chat paths. Keeping the SpecialistChat component for this path as it was mentioned twice.
            path: "chat-specialist",
            Component: SpecialistChat,
         },
         {
            path: "live-chat",
            // Assuming this is for farmers to chat with specialists.
